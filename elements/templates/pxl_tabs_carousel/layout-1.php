    ...
    <?php if ($arrows != false) : ?>
        <div class="pxl-swiper-arrows nav-vertical-in <?php echo esc_attr($arrows_style); ?>">
            <?php if ($arrows_style == 'style-2') : ?>
                ...
                <div class="pxl-swiper-arrow pxl-swiper-arrow-next <?php echo esc_attr($arrow_prev_position == 'center-vertical' ? 'center-vertical' : '') ?>"><span class="pxl-icon zmdi zmdi-arrow-right"></span></div>
            <?php else: ?>
