                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'default' => 15,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-grid:not(.layout-5) .pxl-grid-inner' => 'margin-left: -{{VALUE}}px; margin-right: -{{VALUE}}px;',
                                '{{WRAPPER}} .pxl-grid.layout-5 .pxl-grid-inner' => 'margin-left: 0px; margin-right: 0px;',
                                '{{WRAPPER}} .pxl-grid:not(.layout-5) .grid-item' => 'padding-left: {{VALUE}}px; padding-right: {{VALUE}}px; margin-top: {{VALUE}}px; margin-bottom: {{VALUE}}px;',
