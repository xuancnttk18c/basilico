                                    ...
                                    array(
                                        ...
                                        'controls' => array(
                                            array(
                                                ...
                                                'selectors' => [
                                                    '{{WRAPPER}} .pxl-contact-form7 input[type="text"], {{WRAPPER}} .pxl-contact-form7 input[type="password"], {{WRAPPER}} .pxl-contact-form7 input[type="email"], {{WRAPPER}} .pxl-contact-form7 input[type="phone"]' => 'background-color: {{VALUE}};',
                                                ],
                                            ),
                                            array(
                                            ...
                                            array(
                                                ...
                                                'type' => \Elementor\Controls_Manager::COLOR,
                                                'selectors' => [
                                                    '{{WRAPPER}} .pxl-contact-form7 input[type="text"], {{WRAPPER}} .pxl-contact-form7 input[type="password"], {{WRAPPER}} .pxl-contact-form7 input[type="email"], {{WRAPPER}} .pxl-contact-form7 input[type="phone"]' => 'border-color: {{VALUE}};',
                                                ],
                                            ),
                                            array(
                                        ...
                                        'controls' => array(
                                            ...
                                            array(
                                                ...
                                                'selectors' => [
                                                    ...
                                                    {{WRAPPER}} .pxl-contact-form7 input[type="password"]:hover,
                                                    {{WRAPPER}} .pxl-contact-form7 input[type="email"]:hover,
                                                    {{WRAPPER}} .pxl-contact-form7 input[type="phone"]:hover' => 'color: {{VALUE}};',
                                                ],
                                            ),
                                            array(
