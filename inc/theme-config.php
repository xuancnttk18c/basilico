    ...
    function basilico_configs($value){
        ...
        $configs = [
            ...
            'input' => [
                ...
                'height'            => basilico()->get_opt('input_height', ['height' => '44px', 'units' => 'px'])['height'] != 'px' ? basilico()->get_opt('input_height', ['height' => '44px', 'units' => 'px'])['height'] : '44px',
                'border-radius'     => basilico()->get_opt('input_border_radius2', ['width' => '0px', 'units' => 'px'])['width'] != 'px' ? basilico()->get_opt('input_border_radius2', ['width' => '0px', 'units' => 'px'])['width'] : '0px',
