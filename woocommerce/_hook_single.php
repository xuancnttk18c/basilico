...
if(!function_exists('basilico_woocommerce_before_single_product_summary')){
	...
	function basilico_woocommerce_before_single_product_summary(){
		...
		$sidebar_pos = basilico()->get_theme_opt('product_sidebar_pos', '0');
...
if(!function_exists('basilico_wc_template_single_meta')){
	...
	function basilico_wc_template_single_meta(){
		...
		if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) {
			$sku = $product->get_sku() ? $product->get_sku() : esc_html__( 'N/A', 'basilico' );
...
function basilico_variable_add_to_cart(){
	global $product;
 	...
 	$product_variation_style = isset($_GET['variation-style']) ? sanitize_text_field($_GET['variation-style']) : basilico()->get_theme_opt('product_variation_style','dropdown');
							...
							<div class="pxl-variation-row row">
								...
								<div class="value col-12">
									<?php
										...
										echo end( $attribute_keys ) === $attribute_name ? wp_kses_post( apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations d-none" href="#">' . esc_html__( 'Clear', 'basilico' ) . '</a>' ) ) : '';
									?>
								</div>
							</div>
						<?php endforeach; ?>
