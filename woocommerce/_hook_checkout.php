...
if(!function_exists('basilico_woocommerce_order_button_html')){
	...
	function basilico_woocommerce_order_button_html(){
		...
		return '<div class="pxl-checkout-place-order"><button type="submit" class="button ' . esc_attr($checkout_btn_style) . '" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '"><span>' . esc_html( $order_button_text ) .'</span></button></div>';
	}
}